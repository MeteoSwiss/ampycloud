...
class CeiloChunk(AbstractChunk):
    ...
    def metarize(self, which: int = 'slices', base_lvl_alt_perc: float = 5.,
        ...
        Args:
            ...
            lim0 (int, optional): maximum (absolute) number of hits allowed in a slice/group/layer
                for it to be considered to be 0 oktas. Defaults to 0.
            lim8 (int, optional): maximum (absolute) number of holes (=non-detection of a cloud
                base) allowed in a slice/group/layer for it to be considered to be 8 oktas.
                Defaults to 0.
