...
def test_mock_layers():
    ...
    lookback_time = 1200
    hit_gap = 60
    layer_prms = [{"height": 1000, "height_std": 100, "sky_cov_frac": 1, "period": 100, "amplitude": 0}]
    ...
    lookback_time = 1200
    hit_gap = 60
    layer_prms = [{"height": 1000, "height_std": 100, "sky_cov_frac": 0.5, "period": 100, "amplitude": 0}]
    out = mock_layers(n_ceilos, lookback_time, hit_gap, layer_prms)
    ...
    layer_prms = [
        ...
        {"height": 10000, "height_std": 200, "sky_cov_frac": 1, "period": 100, "amplitude": 0},
    ]
    out = mock_layers(n_ceilos, lookback_time, hit_gap, layer_prms)
    ...
    layer_prms = [
        {"height": 1000, "height_std": 100, "sky_cov_frac": 1, "period": 100, "amplitude": 0},
        {"height": 15000, "height_std": 200, "sky_cov_frac": 1, "period": 100, "amplitude": 0},
    ]
    out = mock_layers(n_ceilos, lookback_time, hit_gap, layer_prms)
